...
public class LocationModePreferenceController extends LocationBasePreferenceController {
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        new SubSettingLauncher(mParentFragment.getContext())
                .setDestination(LocationMode.class.getName())
                .setTitle(R.string.location_mode_screen_title)
                .setSourceMetricsCategory(mParentFragment.getMetricsCategory())
                .setResultListener(mParentFragment, 0)
                .launch();
            return true;
        }
        return false;
